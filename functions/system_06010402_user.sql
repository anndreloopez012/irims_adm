CREATE OR REPLACE FUNCTION "public"."system_06010402_user"("v_cod" int4,
    ...
    BEGIN
		...
		IF v_cod = 2 THEN
			...
			SET
                ...
                vus_cnf_regusr_cor = v_vus_cnf_regusr_cor ,
                vus_cnf_solreg_cor = v_vus_cnf_solreg_cor ,
                ...
                vus_cnf_addprod = v_vus_cnf_addprod ,
                vus_cnf_editemp = v_vus_cnf_editemp ,
