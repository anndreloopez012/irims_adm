CREATE OR REPLACE FUNCTION "public"."system_06010104"("v_cod" int4,
                                                    "v_adm_order" varchar,
                                                    "v_adm_name" varchar,
    ...
    BEGIN
		...
		IF v_cod = 2 THEN
			...
			SET
                ...
                adm_acceso_pertenece = v_adm_acceso_pertenece 
