    ...
    <div class="row">
        ...
        <div class="cont col-lg-8">
            <form id="formData" method="POST">
                <ul class="nav nav-pills nav-fill btn-dark">
                    <li class="nav-item">
                        <button type="button" id="insert" onclick="fntUpdate()" id="save" class="btn btn-dark btn-block">Save</button>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card-body bg-secondary sub-menu text-white col-12">
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn-dark sub-menu-btn text-white" id="four" data-toggle="pill" href="#four_" role="tab" aria-controls="four" aria-selected="false">PAYMENT OF RIGHTS OF USE</a>
                        </li>
                        <li class="nav-item">
