        ...
        <div class="cont col-lg-8">
            <form id="formData" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input class="form-control form-control-sm" name="pass" id="password" type="text" required>
                    </div>
                </div>
                <div class="card-body bg-secondary sub-menu text-white col-12">
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn-dark sub-menu-btn text-white" id="ten" data-toggle="pill" href="#ten_" role="tab" aria-controls="ten" aria-selected="true">COMPANY</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="custom-content-below-tabContent content-input-size">
                        ...
                        <div class="tab-pane fade col-12" id="three_" role="tabpanel" aria-labelledby="three"><br>
                            <div class="form-group size row">
                                <label for="tpr_g" class="col-sm-5 col-form-label-sm">Product(s):</label>
                                <input name="tpr_id" id="tpr_id" type="hidden" required>
