            ...
            <form id="formData" method="POST">
                ...
                <div class="card-body bg-secondary sub-menu text-white col-12">
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn-dark sub-menu-btn text-white" id="four" data-toggle="pill" href="#four_" role="tab" aria-controls="four" aria-selected="false">POWERS OF ATTORNEY</a>
                        </li>
                        <li class="nav-item">
...
<script>
    ...
    function fntSelect(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            //alert(strIdUsr + "                         strIdUsr");

            $("#id_codigo").val(strCodigoDes);
