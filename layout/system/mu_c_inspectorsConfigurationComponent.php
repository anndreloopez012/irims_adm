            ...
            <div class="cont col-lg-8">
                <form id="formData" method="POST">
                    ...
                    <div class="form-group row">
                        <label for="codigo" class="col-sm-3 col-form-label-sm">Country of installation</label>
                        ...
                        <div class="col-sm-1">
                            <input class="form-control form-control-sm" name="diasven" id="diasven" type="text" required value="<?php echo  $vus_cnf_diasven; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control form-control-sm" name="email3" id="email3" value="<?php echo  $vus_cnf_email3; ?>" type="text" required>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    function fntDibujoTabla() {
        ...
        $.ajax({
            ...
            url: "mu_c_inspectorsConfiguration.php?validaciones=busqueda_geografia",
            data: {
                Search: strSearch,
            },
            async: true,
