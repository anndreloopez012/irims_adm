            ...
            <div class="cont col-lg-8">
                <form id="formData" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 checkRadio">
                            <div class="form-check">
                                <input type="checkbox" value="1" name="review" id="review_ " class="form-check-input">
                                <input type="hidden" value="1" name="review_val" id="review_val " class="form-check-input">
                                <label class="form-check-label">Evaluation: Pass by review Board</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" value="1" name="approved" id="approved_" class="form-check-input">
                                <input type="hidden" value="1" name="approved_val" id="approved_val" class="form-check-input">
                                <label class="form-check-label">Evaluation: DAC approved</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" value="1" name="final" id="final_" class="form-check-input">
                                <input type="hidden" value="1" name="final_val" id="final_val" class="form-check-input">
                                <label class="form-check-label">Evaluation: Pass by final Result</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="exampleFormControlSelect1" class="col-sm-2 col-form-label">It is shown in VUS</label>
                        <div class="col-sm-1">
                            <select class="form-control" name="vus" id="vus">
                                <option value="">..</option>
