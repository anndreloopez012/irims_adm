        ...
        <div class="row">
          <div class="col-lg-2"></div>
            ...
            <form id="formData" method="POST"> 
                ...
                <div class="form-group row">
                    <label for="vus" class="col-sm-2 col-form-label">VUS fields</label>
                    <div class="col-sm-4">
                        <input class="form-control " id="vus" name="vus" type="text" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="dat" class="col-sm-2 col-form-label">DAT fields</label>
                    <div class="col-sm-4">
                        <input class="form-control " id="dat" name="dat" type="text" required>
                    </div>
                </div>
                <div class="form-group row">
...
<script>
 function fntSelect(intParametro){
  ...
  if ( intParametro>0 ){
    ...
    var strDat = $("#hidDat_"+intParametro).val();
...
function fntDibujoTablaProducto(){
  ...
  $.ajax({
      ...
      url: "mu_slt_fieldsForProcedureOfChange.php?validaciones=busqueda_categoria",
      data: {
