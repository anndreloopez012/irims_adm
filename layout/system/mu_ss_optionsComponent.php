          ...
          <div class="col-lg-2"></div>
            ...
            <ul class="nav nav-pills nav-fill btn-dark">
                ...
                <label for="Code" class="col-sm-2 col-form-label">Menu</label>
                    ...
                    <div class="col-sm-">
                        <input class="form-control " name="modulo" id="modulo"  type="text" disabled>
                    </div>
                </div>
                <div class="form-group row">
                <label for="Code" class="col-sm-2 col-form-label">Options</label>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input class="form-control " name="modulo" id="modulo" type="hidden" >
                        <input class="form-control " name="modulo_ll" id="modulo_ll" type="hidden" >
...
<script>
 function fntSelectModulo_l(intParametro){
  ...
  if ( intParametro>0 ){
    ...
    var strModulo = $("#hidNameMod_l_"+intParametro).val();
    ...
    //alert(strCode + "                                  strCode");
        ...
        $.ajax({
            ...
            url: "mu_ss_options.php?validaciones=busqueda_modulos_ll",
            data: {
                    code:strCode,
                },
            async: true,
...
function fntDibujoTablaModulo_l(){
        ...
        $.ajax({
            ...
            url: "mu_ss_options.php?validaciones=busqueda_modulos_l",
            data: {
