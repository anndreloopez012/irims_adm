          ...
          <div class="col-lg-2"></div>
            ...
            <ul class="nav nav-pills nav-fill btn-dark">
                ...
                <div class="form-group row">
                    <label for="dropOne" class="col-sm-2 col-form-label">Modules</label>
                    <div class="col-sm-3">
                ...
                <label for="Code" class="col-sm-2 col-form-label">Menu</label>
                    ...
                    <div class="col-sm-4">
                        <input class="form-control " name="modulo_l" id="modulo_l" type="text" disabled>
                    </div>
                </div>
                <div class="form-group row">
                <label for="Code" class="col-sm-2 col-form-label">Options</label>
                    <input class="form-control " name="id_opcion" id="id_opcion" type="hidden" >
                    <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#basicExampleModalTwo">
                        <i class="fas fa-search" ></i>
                    </button>
                    <div class="col-sm-2">
                        <input class="form-control " name="idOptions" id="idOptions" type="hidden" required>
                        <input class="form-control " name="Options" id="Options" onkeyup="fntValidacionOptions();" type="text" required>
                    </div>
                    <div class="col-sm-4">
                        <input class="form-control " name="modulo_ll" id="modulo_ll" type="text" disabled>
                    </div>
                </div>
                <div class="form-group row">
                <label for="Code" class="col-sm-2 col-form-label">Sub-Option</label>
                    <input class="form-control " name="id_sub" id="id_sub" type="hidden" >
                    <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#basicExampleModalThre">
                        <i class="fas fa-search"></i>
                    </button>
                    <div class="col-sm-2">
                        <input class="form-control " name="Sub_Option" id="Sub_Option" onkeyup="fntValidacionSubOptions();" type="text" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="Description" class="col-sm-2 col-form-label">Order</label>
                    <div class="col-sm-2">
...
<script>
 function fntSelectModulo_l(intParametro){
  ...
  if ( intParametro>0 ){
    ...
    var strModulo_l = $("#hidNameMod_l_"+intParametro).val();

    $("#id").val(strId);
    $("#code").val(strCodigo);
    $("#modulo_l").val(strModulo_l);
  }
    ...
    //alert(strCode + "                                  strCode");
        ...
        $.ajax({
            ...
            url: "mu_ss_subOptions.php?validaciones=busqueda_modulos_ll",
            data: {
                    code:strCode,
                },
            async: true,
 ...
 function fntSelectModulo_ll(intParametro){
  ...
  if ( intParametro>0 ){
    ...
    var strModulo_ll = $("#hidIdModulo_"+intParametro).val();

    $("#idOptions").val(strIdOption);
    $("#Options").val(strOption);
    $("#modulo_ll").val(strModulo_ll);
  }
    ...
    //alert(strOption + "                                  strOption");
        ...
        $.ajax({
            ...
            url: "mu_ss_subOptions.php?validaciones=busqueda_modulos_lll",
            data: {
                    Options:strOption,
                },
            async: true,
...
function fntSelectModulo_lll(intParametro){
  document.getElementById('replace').disabled=true;
  document.getElementById('delete').disabled=false;
  ...
  if ( intParametro>0 ){
    ...
    var strIdOption = $("#hidId_lll_"+intParametro).val();
    var strOption = $("#hidCode_lll_"+intParametro).val();
    var strDescrip = $("#hidDescrip_"+intParametro).val();
    var strComent = $("#hidObs_"+intParametro).val();
    var strOrder = $("#hidNum_"+intParametro).val();
    var strModulo = $("#hidIdModulo_"+intParametro).val();
    var strAcceso = $("#hidIdAcceso_"+intParametro).val();
    var strRtu = $("#hidRtu_"+intParametro).val();

    //alert(strOrder + "                                  strDescrip");
    ...
    $("#modulo").val(strModulo);
    $("#Sub_Option").val(strAcceso);
    $("#rtu").val(strRtu);
...
function fntDibujoTablaModulo_l(){
        ...
        $.ajax({
            ...
            url: "mu_ss_subOptions.php?validaciones=busqueda_modulos_l",
            data: {
