        ...
        <div class="row">
          <div class="col-lg-2"></div>
            ...
            <form id="formData" method="POST"> 
                ...
                <div class="form-group row">
                    <label for="Acronym" class="col-sm-2 col-form-label">Acronyms format</label>
                    <div class="col-sm-6">
                        <input class="form-control" name="acronym" id="acronym" type="text" required>
                    </div>
                </div>
                <div class="form-group row">
                        <label for="Acronym" class="col-sm-2 col-form-label">Initial correlative</label>
                    <div class="col-sm-2">
                        <input class="form-control" name="Initial" id="Initial" type="text" required>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="1" name="Certificate" id="Certificate " class="form-check-input" >
                        <label class="form-check-label" >Certificate</label>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="Acronym" class="col-sm-2 col-form-label">Format Name</label>
                    <div class="col-sm-6">
                        <input class="form-control" name="Format" id="Format" type="text" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="Acronym" class="col-sm-2 col-form-label">Last updated date</label>
                    <div class="col-sm-6">
                        <input class="form-control" name="Last" id="Last" type="text" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="Acronym" class="col-sm-2 col-form-label">Version</label>
                    <div class="col-sm-6">
                        <input class="form-control" name="Version" id="Version" type="text" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="Acronym" class="col-sm-2 col-form-label">Physical file name</label>
                    <div class="col-sm-6">
                        <input class="form-control" name="Physical" id="Physical" type="text" required>
                    </div>
                </div>
                <div class="form-group row">
...
<script>
 function fntSelect(intParametro){
  ...
  if ( intParametro>0 ){
    ...
    var strAcronyms = $("#hidAcronyms_"+intParametro).val();
    var strInitial = $("#hidInitial_"+intParametro).val();
    var strFormat = $("#hidFormat_"+intParametro).val();
    var strCertificate = $("#hidCertificate_"+intParametro).val();
    var strLast = $("#hidLast_"+intParametro).val();
    var strVersion = $("#hidVersion_"+intParametro).val();
    var strPhysical = $("#hidPhysical_"+intParametro).val();
    ...
    $("#acronym").val(strAcronyms);
    $("#Initial").val(strInitial);
    $("#Format").val(strFormat);

    var boolCheckPass = (strCertificate == 1)?true:false;
    $("[name=Certificate]").prop('checked',boolCheckPass);
    $("#Certificate").val(strCertificate);

    $("#Last").val(strLast);
    $("#Version").val(strVersion);
    $("#Physical").val(strPhysical);
...
$.ajax({
    ...
    url: "mu_slt_reportFormats.php?validaciones=busqueda_categoria",
    data: {
            Search:strSearch,
