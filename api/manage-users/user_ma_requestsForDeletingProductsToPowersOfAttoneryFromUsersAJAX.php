<script>
    ...
    function fntUpdate() {
        ...
        alertify.confirm('AVISO', 'Are you sure you wish to continue? ', function() {
            ...
            $.ajax({
                ...
                data: datos,
                dataType: 'json',
                url: "ma_requestsForDeletingProductsToPowersOfAttoneryFromUsers.php?ajax=true&validaciones=proces_update",
                success: function(r) {
                    if (r.status) {
                        if (r.status == 1) {
                            fntSelectTabla()
    ...
    function fntProsesDelete() {
            ...
            $.ajax({
                ...
                data: datos,
                dataType: 'json',
                url: "ma_requestsForDeletingProductsToPowersOfAttoneryFromUsers.php?ajax=true&validaciones=proces_delete",
                success: function(r) {
                    if (r.status) {
                        if (r.status == 1) {
    ...
    function fntDibujoTabla() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForDeletingProductsToPowersOfAttoneryFromUsers.php?validaciones=busqueda_tabla",
            data: {
    ...
    function fntDibujoCompany() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForDeletingProductsToPowersOfAttoneryFromUsers.php?validaciones=data_company",
            data: {
                rif: strRif,
            },
            async: true,
    ...
    function fntDibujoDowload() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForDeletingProductsToPowersOfAttoneryFromUsers.php?validaciones=data_dowload",
            data: {
                CodId: strCodId,
            },
            async: true,
