<script>
    ...
    function fntUpdate() {
        ...
        alertify.confirm('AVISO', 'Seguro que desea continuar? ', function() {
            ...
            $.ajax({
                ...
                data: datos,
                dataType: 'json',
                url: "ma_requestsForRemovalProductTypeFromUsers.php?ajax=true&validaciones=proces_update",
                success: function(r) {
                    if (r.status) {
                        if (r.status == 1) {
                            fntProsesDelete()
    ...
    function fntProsesDelete() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "ma_requestsForRemovalProductTypeFromUsers.php?ajax=true&validaciones=proces_delete",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
                        //fntDibujoTabla()
    ...
    function fntDibujoTabla() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForRemovalProductTypeFromUsers.php?validaciones=busqueda_tabla",
            data: {
    ...
    function fntDibujoDfdaSection() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForRemovalProductTypeFromUsers.php?validaciones=dfda_section",
            data: {
    ...
    function fntDibujoCompany() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForRemovalProductTypeFromUsers.php?validaciones=data_company",
            data: {
                rif: strRif,
            },
            async: true,
    ...
    function fntDibujoIdSolReg() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForRemovalProductTypeFromUsers.php?validaciones=vus_solreg_ids",
            data: {
