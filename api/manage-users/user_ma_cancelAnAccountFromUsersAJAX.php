<script>
    ...
    function fntUpdateInsert() {
        ...
        alertify.confirm('AVISO', 'Seguro que desea continuar? ', function() {
            ...
            $.ajax({
                ...
                data: datos,
                dataType: 'json',
                url: "ma_cancelAnAccountFromUsers.php?ajax=true&validaciones=proces",
                success: function(r) {
                    if (r.status) {
                        if (r.status == 1) {
                            fntDibujoTabla()
    ...
    function fntDibujoTabla() {
        ...
        $.ajax({
            ...
            url: "ma_cancelAnAccountFromUsers.php?validaciones=busqueda_tabla",
            data: {
    ...
    function fntDibujoDfdaSection() {
        ...
        $.ajax({
            ...
            url: "ma_cancelAnAccountFromUsers.php?validaciones=dfda_section",
            data: {
    ...
    function fntDibujoCompany() {
        ...
        $.ajax({
            ...
            url: "ma_cancelAnAccountFromUsers.php?validaciones=data_company",
            data: {
                rif: strRif,
            },
            async: true,
    ...
    function fntDibujoIdSolReg() {
        ...
        $.ajax({
            ...
            url: "ma_cancelAnAccountFromUsers.php?validaciones=vus_solreg_ids",
            data: {
    ...
    function fntDibujoDowload() {
        ...
        $.ajax({
            ...
            url: "ma_cancelAnAccountFromUsers.php?validaciones=data_dowload",
            data: {
