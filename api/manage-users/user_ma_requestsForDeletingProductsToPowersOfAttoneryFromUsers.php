...
if (isset($_GET["validaciones"]) && !empty($_GET["validaciones"])) {
    ...
    if ($strTipoValidacion == "proces_delete") {
            ...
            foreach ($arrDataPod as $keyA => $valueA) {
                ...
                if ($boolHasAccesosPod) {
                    ...
                    foreach ($valueA["accesos"] as $keyB => $valueB) {
                        ...
                        $var_consulta = "DELETE FROM vus_usuarios_poderes_prods WHERE vus_upr_poder_id = " . $valueB["vus_solupr_poder_id"] . " AND vus_upr_numreg = '" . $valueB["vus_solupr_numreg"] . "' AND vus_upr_id = $userId";
        ...
        header('Content-Type: application/json');
        $var_consulta = "UPDATE vus_usuarios_solicitudes SET vus_sol_sta = '$status' WHERE vus_sol_num = $numSol";
