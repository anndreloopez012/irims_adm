<script>
    ...
    function fntUpdate() {
        ...
        alertify.confirm('AVISO', 'Seguro que desea continuar? ', function() {
            ...
            $.ajax({
                ...
                data: datos,
                dataType: 'json',
                url: "ma_requestsForDeletionOfPowersOfAttoneryFromUsers.php?ajax=true&validaciones=proces_update",
                success: function(r) {
                    if (r.status) {
                        if (r.status == 1) {
                            fntSelectTabla()

                            fntProsesDeletePoderes()
    ...
    function fntProsesDeletePoderes() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "ma_requestsForDeletionOfPowersOfAttoneryFromUsers.php?ajax=true&validaciones=proces_delete_poderes",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
                        //fntDibujoTabla()
                        //fntProsesDeletePorderesProd()
                        //alertify.alert('AVISO', 'Datos cargados correctamente');
                        //location.reload(); 
                    }
                } else {
    ...
    function fntDibujoTabla() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForDeletionOfPowersOfAttoneryFromUsers.php?validaciones=busqueda_tabla",
            data: {
    ...
    function fntDibujoCompany() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForDeletionOfPowersOfAttoneryFromUsers.php?validaciones=data_company",
            data: {
                rif: strRif,
            },
            async: true,
    ...
    function fntDibujoDowload() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForDeletionOfPowersOfAttoneryFromUsers.php?validaciones=data_dowload",
            data: {
                CodId: strCodId,
            },
            async: true,
