...
if (isset($_GET["validaciones"]) && !empty($_GET["validaciones"])) {
    ...
    if ($strTipoValidacion == "proces") {
        ...
        $var_consulta = "DELETE FROM vus_usuarios_solicitud_registro_productos WHERE vus_solreg_p_id = $userId";
        ...
        $var_consulta = "DELETE FROM vus_usuarios_solicitud_registro WHERE vus_solreg_id = $userId";
    ...
    else if ($strTipoValidacion == "unlink") {
        header('Content-Type: application/json');
        $vus_solreg_id = isset($_POST["codigo_des"]) ? $_POST["codigo_des"]  : '';
        $vus_solreg_fecsol = isset($_POST["fecsol"]) ? $_POST["fecsol"]  : '';
        //CICLO
    ...
    //DIBUJO DE TABLA PRODUCTOS CATEGORIAS
        ...
        while ($rTMP = pg_fetch_assoc($qTMP)) {
            ...
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_id"]                 = $rTMP["vus_id"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_id"]                 = $rTMP["vus_solreg_id"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_fecsol"]                 = $rTMP["vus_solreg_fecsol"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_alias"]                 = $rTMP["vus_solreg_alias"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_tipcta"]                 = $rTMP["vus_solreg_tipcta"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_ci"]                 = $rTMP["vus_solreg_ci"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_ci_tpo"]                 = $rTMP["vus_solreg_ci_tpo"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_colfar"]                 = $rTMP["vus_solreg_colfar"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_msds"]                 = $rTMP["vus_solreg_msds"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_inprefar"]                 = $rTMP["vus_solreg_inprefar"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_nme1"]                 = $rTMP["vus_solreg_nme1"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_nme2"]                 = $rTMP["vus_solreg_nme2"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_ape1"]                 = $rTMP["vus_solreg_ape1"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_ape2"]                 = $rTMP["vus_solreg_ape2"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_nombre"]                 = $rTMP["vus_solreg_nombre"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_emp_rif"]                 = $rTMP["vus_solreg_emp_rif"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_password"]                 = $rTMP["vus_solreg_password"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_email"]                 = $rTMP["vus_solreg_email"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_tel"]                 = $rTMP["vus_solreg_tel"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_cel"]                 = $rTMP["vus_solreg_cel"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["ctg_geo_id"]                 = $rTMP["ctg_geo_id"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_urb"]                 = $rTMP["vus_solreg_urb"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_ave"]                 = $rTMP["vus_solreg_ave"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_edi"]                 = $rTMP["vus_solreg_edi"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_pis"]                 = $rTMP["vus_solreg_pis"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_codpos"]                 = $rTMP["vus_solreg_codpos"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_punref"]                 = $rTMP["vus_solreg_punref"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_estatus"]                 = $rTMP["vus_solreg_estatus"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_estatus_aut"]                 = $rTMP["vus_solreg_estatus_aut"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_estatus_rec"]                 = $rTMP["vus_solreg_estatus_rec"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_obs"]                 = $rTMP["vus_solreg_obs"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_dir"]                 = $rTMP["vus_solreg_dir"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_ciudad"]                 = $rTMP["vus_solreg_ciudad"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_origen"]                 = $rTMP["vus_solreg_origen"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_emptpo"]                 = $rTMP["vus_solreg_emptpo"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_file1"]                 = $rTMP["vus_solreg_file1"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_file2"]                 = $rTMP["vus_solreg_file2"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_file3"]                 = $rTMP["vus_solreg_file3"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_file4"]                 = $rTMP["vus_solreg_file4"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_file5"]                 = $rTMP["vus_solreg_file5"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_file6"]                 = $rTMP["vus_solreg_file6"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_file7"]                 = $rTMP["vus_solreg_file7"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_file8"]                 = $rTMP["vus_solreg_file8"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_file9"]                 = $rTMP["vus_solreg_file9"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_sta"]                 = $rTMP["vus_solreg_sta"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_usr"]                 = $rTMP["vus_solreg_usr"];
            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_dt"]                 = $rTMP["vus_solreg_dt"];

            $arrTypeMessage[$rTMP["vus_solreg_id"]]["vus_solreg_tpr_id"]                 = $rTMP["vus_solreg_tpr_id"];
        }
        pg_free_result($qTMP);
                ...
                <tbody>
                    ...
                    ?>
                            <tr style="cursor:pointer;" onclick="fntSelect('<?php print $intContador; ?>');">
                                ...
                                <td WIDTH="10%"><?php echo  $rTMP["value"]['vus_solreg_fecsol']; ?></td>
                            ...
                            <input type="hidden" name="hid_codigo_des<?php print $intContador; ?>" id="hid_codigo_des<?php print $intContador; ?>" value="<?php echo  $rTMP["value"]['vus_solreg_id']; ?>">
