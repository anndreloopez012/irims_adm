                ...
                <tbody>
                    ...
                    ?>
                            <tr style="cursor:pointer;" onclick="fntSelect('<?php print $intContador; ?>');">
                                <td><?php echo  $rTMP["value"]['vus_solreg_id']; ?></td>
                                <td><?php echo  $rTMP["value"]['vus_solreg_fecsol']; ?></td>
                                ...
                                <td><?php
                                    if ($rTMP["value"]['vus_solreg_estatus'] == 0) {
                                        echo 'Enviada';
                                    } else if ($rTMP["value"]['vus_solreg_estatus'] == 1) {
                                        echo 'Autorizada';
                                    } else if ($rTMP["value"]['vus_solreg_estatus'] == 2) {
                                        echo 'Rechazada';
                                    } else if ($rTMP["value"]['vus_solreg_estatus'] == 3) {
                                        echo 'Deshabilitada';
                                    } else if ($rTMP["value"]['vus_solreg_estatus'] == 4) {
                                        echo 'Cancelada';
                                    }
                                    ?>
                                </td>
