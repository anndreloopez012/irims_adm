<script>
    ...
    function fntUpdate() {
        ...
        alertify.confirm('AVISO', 'Seguro que desea continuar? ', function() {
            ...
            $.ajax({
                ...
                data: datos,
                dataType: 'json',
                url: "ma_requestsForAddingProductsToPowersOfAttoneryFromUsers.php?ajax=true&validaciones=proces_update",
                success: function(r) {
                    if (r.status) {
                        if (r.status == 1) {
                            fntSelectTabla()
    ...
    function fntProsesInsert() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "ma_requestsForAddingProductsToPowersOfAttoneryFromUsers.php?ajax=true&validaciones=proces_insert",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
                        //fntDibujoTabla()
    ...
    function fntDibujoTabla() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForAddingProductsToPowersOfAttoneryFromUsers.php?validaciones=busqueda_tabla",
            data: {
    ...
    function fntDibujoCompany() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForAddingProductsToPowersOfAttoneryFromUsers.php?validaciones=data_company",
            data: {
                rif: strRif,
            },
            async: true,
    ...
    function fntDibujoDowload() {
        ...
        $.ajax({
            ...
            url: "ma_requestsForAddingProductsToPowersOfAttoneryFromUsers.php?validaciones=data_dowload",
            data: {
                CodId: strCodId,
            },
            async: true,
